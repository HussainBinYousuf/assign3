CC = gcc
OFILES = dberror.o expr.o record_mgr.o rm_serializer.o storage_mgr.o buffer_mgr.o
CFLAGS = -g -Wall 
...
recordmgr: test_assign3_1.o $(OFILES) buffer_mgr_stat.o
	$(CC) $(CFLAGS) -o recordmgr test_assign3_1.o $(OFILES) -lm buffer_mgr_stat.o -lpthread

test_expr: test_expr.o $(OFILES) buffer_mgr_stat.o
	$(CC) $(CFLAGS) -o test_expr test_expr.o $(OFILES) -lm buffer_mgr_stat.o -lpthread
